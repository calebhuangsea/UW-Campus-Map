...
/**
 * This represents an immutable path between two objects
...
public class Path<T> implements Iterable<Path<T>.Segment>, Comparable<Path<T>> {
    ...
    // AF(this) =
    //      first object in the path => start objects => elements of list path, where
     ...
     * are created as part of larger paths by calling Path#extend(object, double).
     */
